...
public class XeroXmlManager {
    ...
    public static String attachmentsToXml(ArrayOfAttachment arrayOfAttachments) {
        ...
        try {
            ...
            ObjectFactory factory = new ObjectFactory();
            JAXBElement<ArrayOfAttachment> element = factory.createAttachments(arrayOfAttachments);

            StringWriter stringWriter = new StringWriter();
            marshaller.marshal(element, stringWriter);
            attachmentsString = stringWriter.toString();
    ...
    public static String creditNotesToXml(ArrayOfCreditNote arrayOfCreditNotes) {

        String creditNotesString = null;
        ...
        try {
            ...
            ObjectFactory factory = new ObjectFactory();
            JAXBElement<ArrayOfCreditNote> element = factory.createCreditNotes(arrayOfCreditNotes);

            StringWriter stringWriter = new StringWriter();
            marshaller.marshal(element, stringWriter);
            creditNotesString = stringWriter.toString();

        } catch (JAXBException ex) {
            ex.printStackTrace();
        }

        return creditNotesString;
    }
