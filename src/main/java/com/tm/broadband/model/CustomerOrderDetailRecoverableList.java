...
public class CustomerOrderDetailRecoverableList implements Serializable {
	...
	public void setDetail_expired(Date detail_expired) {
		this.setDetail_expired_str(TMUtils.dateFormatYYYYMMDD(detail_expired));
