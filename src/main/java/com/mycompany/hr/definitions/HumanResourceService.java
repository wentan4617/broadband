 ...
 * 
 */
@WebServiceClient(name = "HumanResourceService", targetNamespace = "http://mycompany.com/hr/definitions", wsdlLocation = "http://localhost:8080/broadband/services/holidayService/holiday.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/broadband/services/holidayService/holiday.wsdl");
