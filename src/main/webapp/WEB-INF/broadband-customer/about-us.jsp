...
<script type="text/javascript"
	src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVW1VF22QhBHMntGWSOt1Vqi5l88cPak8&sensor=true&region=NZ">
...
<body onload="initialize()">
	<div id="map_canvas"
		style="margin: 50px 0 0 50px; width: 500px; height: 360px"></div>
