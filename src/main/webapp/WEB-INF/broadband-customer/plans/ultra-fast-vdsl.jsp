	...
	<div class="row">
		<div class="col-md-5 col-md-offset-4">
			<ul class="nav nav-pills" style="margin:10px auto;">
				...
				<li class="active"><a href="${ctx }/plans/ultra-fast-vdsl">Ultra Fast VDSL</a></li>
				<li><a href="${ctx }/plans/ultra-fast-fibre">Ultra Fast Fibre </a></li>
			</ul>
		</div>
	</div>
</div>
...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<c:set var="planMap" value="${planTypeMap['VDSL'] }"></c:set>
				...
				<div class="panel-body tab-pane fade in active" id="homeline" >
					...
					<c:when test="${fn:length(plansClothed) > 0}">
						...
						<div class="col-md-${count >= 3 ? 4 : 6 } " style="margin-top:5px;">
							<button class="btn btn-danger btn-block" data-vdsl data-id="${plan.id }">
...
(function($){
	...
	$('button[data-vdsl]').click(function(){
		var select_plan_id = $(this).attr('data-id');
		window.location.href = '${ctx}/plans/address-check/vdsl/' + select_plan_id;
	});
