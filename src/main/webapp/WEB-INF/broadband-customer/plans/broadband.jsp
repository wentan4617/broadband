	...
	<div class="row">
		<div class="col-md-12">
			...
			<ul class="nav nav-tabs nav-justified">
				<li class="active"><a href="#homeline" data-toggle="tab"><strong style="font-size:24px;"><span class="phone"></span> VoIP Homeline Included</strong></a></li>
						...
						<div class="col-md-${count >= 3 ? 4 : 6 } " style="margin-top:5px;">
							<button class="btn btn-${color } btn-block" data-type data-id="${plan.id }">
								...
								<p class="text-center" style="font-weight:bold;font-size: 24px;">
									<c:choose>
										<c:when test="${type_search=='ADSL' }">(VoIP Homeline Included)</c:when>
										<c:when test="${type_search=='VDSL' }">(VoIP Homeline Included)</c:when>
