...
<div class="container" style="margin-top:30px;">
	<div class="row btn-purple" style="margin-bottom:10px;">
		...
		<div class="col-md-6">
			<h1 class="lead" style="padding:10px 20px 0;margin-bottom:0;font-size: 36px;font-weight: bold;">Unlimited Data</h1>
			<h1 class="lead" style="padding:10px 20px 0;margin-bottom:0;font-size: 36px;font-weight: bold;">VoIP Homeline</h1>
	...
	<div class="row btn-warning" style="margin-bottom:10px;">
		...
		<div class="col-md-6">
			<h2 class="lead" style="padding:20px 20px 0;">ADSL BROADBAND</h2>
	...
	<div class="row btn-danger" style="margin-bottom:10px;">
		...
		<div class="col-md-6">
			<h2 class="lead" style="padding:20px 20px 0;">High Speed VDSL</h2>
			<p style="padding:0 20px 0;">
	...
	<div class="row btn-info" style="margin-bottom:10px;">
		...
		<div class="col-md-6">
			<h2 class="lead" style="padding:20px 20px 0;">Ultra-Fast-Fibre</h2>
			<p style="padding:0 20px 0;">
	...
	<div class="row btn-success" style="margin-bottom:10px;">
		...
		<div class="col-md-6">
			<h2 class="lead" style="padding:20px 20px 0;">Top-Up Plans</h2>
			<p style="padding:0 20px 0;">
