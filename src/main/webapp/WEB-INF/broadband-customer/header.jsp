...
<head>
    ...
    <meta name="description" content="CyberPark provides broadband, phone, and other internet services to savvy New Zealand homes and businesses. The first company in New Zealand to unbundle the local loop, and the first ISP provider which provides broadband topup services in New Zealand, CyberPark offers quality products, backed by outstanding service. CyberPark是新西兰目前最前沿的网络服务供应商, 我们的特色服务涵盖宽带充值; 商业及个体用户一体化解决方案套装. 签约及非签约的快速宽带; 极速宽带; 光纤等大带宽服务.">
