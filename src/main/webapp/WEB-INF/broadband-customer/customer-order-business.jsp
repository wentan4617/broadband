				...
				<div class="panel panel-success">
					...
					<div id="application" class="panel-collapse collapse in">
						<div class="panel-body">
							<h4 class="text-success">Company Address</h4>
							<hr/>
							...
							<!-- customer account -->
							<hr/>
							<h4 class="text-success">Create Company Account</h4>
							<hr/>
							<div class="form-group">
								<label for="cellphone" class="control-label col-md-4">Contract Mobile</label>
								<div class="col-md-4">
							...
							<div class="form-group">
								<label for="email" class="control-label col-md-4">Contract Email</label>
								<div class="col-md-4">
				...
				<div data-spy="affix" data-offset-top="150" class="panel panel-success">
					<div class="panel-heading">
			  		...
			  		<div  class="panel-body">
			    		...
			    		${orderPlan.plan_desc } --%>
			    		<hr/>
						<a href="${ctx }/plans/${fn:toLowerCase(orderPlan.plan_group=='plan-topup'?'t':'p')}" style="width:100px;" class="btn btn-success">Back</a>&nbsp;
