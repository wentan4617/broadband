				...
				<div class="panel-heading">
					<h4 class="panel-title">
						...
						<div class="pull-right">
							<button class="btn btn-success btn-xs" data-name="upload_call_international_rate_csv_file_btn" data-toggle="tooltip" data-placement="bottom" data-original-title="Upload Call International Rate CSV">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="uploadCallInternationalRateCSVModalLabel">
						<strong>Upload Call International Rate CSV</strong>
					</h4>
				</div>
...
(function($) {
	...
	$('#checkbox_callInternationalRates_top').click(function() {
		var b = $(this).prop("checked");
		if (b) {
			$('input[name="checkbox_callInternationalRates"]').prop("checked", true);
		} else {
			$('input[name="checkbox_callInternationalRates"]').prop("checked", false);
		}
	});
	
	$('button[data-name="upload_call_international_rate_csv_file_btn"]').click(function(){
		$('#uploadCallInternationalRateCSVModal').modal('show');
	});
