		...
		<form class="form-horizontal">
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<div class="input-group">
							<p id="${customerOrder.id}_order_status" class="form-control-static">${customerOrder.order_status}</p>
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<div class="input-group">
							<p id="${customerOrder.id}_order_total_price" data-val="${customerOrder.order_total_price}" class="form-control-static">${customerOrder.order_total_price}</p>
						</div>
					</div>
				</div>
				<div class="form-group">
			...
			<table class="table">
				...
				<tbody>
					<c:forEach var="customerOrderDetail"
						...
						<tr>
							<td><a href="${ctx }/broadband-user/crm/customer/edit/">
									${customerOrderDetail.detail_plan_name} </a></td>
							...
							<td id="${customerOrder.id}_order_detail_unit" data-val="${customerOrderDetail.detail_unit}">${customerOrderDetail.detail_unit}</td>
							<td>&nbsp;</td>
						</tr>
					</c:forEach>
				</tbody>
			...
			<div class="form-group">
				...
				<div class="col-md-2">
					<input id="${customerOrder.id}_order_using_start_input" class="form-control" placeholder="Start Date" />
				</div>
				<label class="control-label col-md-1">SVLan</label>
				<div class="col-md-2">
					<input id="${customerOrder.id}_svlan_input" class="form-control" placeholder="SVLan" />
				</div>
				<label class="control-label col-md-1">CVLan</label>
				<div class="col-md-2">
					<input id="${customerOrder.id}_cvlan_input" class="form-control" placeholder="CVLan" />
				</div>
				<div class="col-md-2">
					<c:if test="${customerOrder.svlan!=null}">
						<button id="${customerOrder.id}cvlan" type="submit"
							class="btn btn-success" onclick="saveCustomerOrder();">Edit</button>
					</c:if>
					<c:if test="${customerOrder.svlan==null}">
						<a href="javascript:void(0);" id="${customerOrder.id}" class="btn btn-success"
							data-name="save">Save</a>
					</c:if>
				</div>
			</div>
		</form>
