...
<script type="text/javascript" src="${ctx}/public/bootstrap3/js/bootstrap-switch.min.js"></script>
...
<script type="text/javascript" src="${ctx}/public/bootstrap3/js/user.js?ver=20141030832"></script>
