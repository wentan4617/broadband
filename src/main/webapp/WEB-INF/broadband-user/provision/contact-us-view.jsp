						...
						<tbody>
							<c:forEach var="contactUs" items="${page.results }">
								...
								<tr>
									...
									<td>
										<a id="${contactUs.id }" data-name="respond" data-email="${contactUs.email }" data-status="${contactUs.status }" data-toggle="modal" data-target="#respondContactUsModal" style="cursor:pointer;"><span class="glyphicon glyphicon-envelope btn-lg"></span></a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title" id="respondContactUsModalLabel"><strong>Respond Contact Us</strong></h4>
	      </div>
	      <div class="modal-body">
			<div class="form-group"><strong>Visitor/Customer's Request:</strong></div>
			<div class="form-group">
				<textarea name="content" class="form-control" rows="6"></textarea>
			</div>
			<div class="form-group"><strong>Our Response:</strong></div>
			<div class="form-group">
...
(function($) {
	...
	$('a[data-name="respond"]').click(function(){
		...
		$('textarea[name="content"]').html($('input[data-name="'+this.id+'_content"]').val());
