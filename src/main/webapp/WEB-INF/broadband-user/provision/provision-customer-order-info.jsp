...
(function($){
	...
	$('a[data-name="show_customer_info"]').click(function(){
	...
	$('#provision-customer-order-info-modal').on('show.bs.modal', function (e) {
		...
		if (c_id != null) {
			$.get('${ctx}/broadband-user/provision/customer/' + c_id, function(customer){
				if (customer != null) {
					...
					if (customerOrders != null) {
						var html = "";
						for (var i = 0, len = customerOrders.length; i < len; i++) {
							var customerOrder = customerOrders[i];
							html += '<div class="panel panel-default">';
							html += '<div class="panel-heading">';
							html += 'Order Serial: <span class="text-danger">' + customerOrder.order_serial + '</span>';
							...
							html += '</div>';
							html += '<label class="col-sm-3 control-label">Create Date:</label>';
							...
							html += '</div>';
							html += '<label class="col-sm-3 control-label">Start Date:</label>';
							html += '<div class="col-sm-3">';
